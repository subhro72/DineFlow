      ...
      <div className="min-h-screen flex flex-col bg-ivory">
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-16">
          <div className="w-full max-w-md bg-warm-white border border-border rounded-xl p-8 shadow-sm text-center">
            ...
            <h2 className="text-xl font-bold text-charcoal mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>
              Account created!
            </h2>
            <p className="text-sm text-sage mb-6">Welcome to DineFlow, {form.name.split(' ')[0]}. Your account is ready.</p>
            <button
        ...
        <div className="w-full max-w-md">
          <div className="bg-warm-white border border-border rounded-xl p-8 shadow-sm">
            <div className="mb-8">
              ...
              <p className="text-sm text-sage">Start your 14-day free trial — no card required</p>
            </div>
            ...
            <p className="mt-3 text-xs text-sage text-center">
              ...
              <span className="text-forest font-medium cursor-pointer hover:underline">Terms of Service</span>
            </p>
