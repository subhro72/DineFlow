...
const ALL_CATS = ['All', 'Starters', 'Mains', 'Pasta', 'Desserts', 'Drinks'];
    ...
    <div className="min-h-screen flex flex-col bg-ivory">
      ...
      <div className="bg-warm-white border-b border-border">
        <div className="w-full px-4 md:px-6 lg:px-8 py-12">
          <div className="text-xs font-semibold uppercase tracking-widest text-terracotta mb-2">Our Menu</div>
          <h1 className="text-3xl font-bold text-charcoal mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>
            Explore the Collection
          </h1>
          <p className="text-sage text-sm">Seasonal ingredients, timeless technique.</p>
        </div>
      </div>
      ...
      <div className="w-full px-4 md:px-6 lg:px-8 py-8 flex-1">
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-24">
            ...
            <h3 className="text-base font-semibold text-charcoal mb-2" style={{ fontFamily: 'Sora, sans-serif' }}>
              No results found
            </h3>
            <p className="text-sm text-sage">Try adjusting your search or category filter.</p>
            <button
